...
function NavBar() {
    ...
    const handleLinkClick = () => { //para cerrar el menu una vez que seleccionas otra seccion
      setOpen(false);
    };
    ...
    <nav className="bg-white dark:bg-gray-900 fixed w-full z-20 top-0 left-0 border-b border-gray-200 dark:border-gray-600">
      <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
        ...
        <div
          ...
          id="navbar-sticky"
        >
          <ul className={`flex flex-col p-4 mt-4 font-medium border  border-gray-100 rounded-lg bg-gray-50 md:p-0 md:text-lg md:flex-row md:space-x-8 md:mt-0 md:border-0 md:bg-white dark:bg-gray-800 md:dark:bg-gray-900 dark:border-gray-700`}>
            <li>
              <a
                href="#"
